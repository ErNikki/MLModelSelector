...
class newTestEnvSimplifiedCR(Env):
    ...
    def close(self):
        ...
        return (self.accuracy/(self.frame_per_episode-1))*100, la, self.models_name_to_dict, self.track_actions, self.track_right_actions, self.frame_per_episode
