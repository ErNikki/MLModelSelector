...
#USA SOLO DUE MODELLI!!!
class newTestEnv(Env):
    ...
    def __init__(self, models, test_data_loader, device, frame_per_episode, models_path=Path("../models/")):
        ...
        self.action_space = len(models)+1
    ...
    def step(self, action):     
        ...
        match action:
            ...
            case 2:
                ...
                if label==predictions[2] and predictions.count(label)==1:
                    reward=1
                    self.track_right_actions[2]+=1
                    self.accuracy+=1
                
                elif label==predictions[2]:
                    reward=0.2
                    self.track_right_actions[2]+=1
                    self.accuracy+=1
    ...
    def close(self, print_stats=(False,"")):
        ...
        if self.track_actions[3]==0:
            la.append(0)
        else:
            la.append(self.track_right_actions[3]*100/self.track_actions[3])
        print(la)
